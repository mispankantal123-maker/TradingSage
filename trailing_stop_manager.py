...
def add_trailing_stop_to_position(ticket: int, symbol: str, config: Dict[str, Any] = None) -> bool:
    """Add trailing stop to position"""
    return trailing_manager.add_trailing_stop(ticket, symbol, config)
...
def get_trailing_stops_status() -> Dict[str, Any]:
    ...
    return trailing_manager.get_trailing_status()
